...
<div class="box">
    ...
    <div class="box-header">
        ...
        <form action="{{ route('others.blood_pdf')}}" method="post" style="float: right; margin-right: 3px;">
            @csrf
                    ...
                    <tr>
                        ...
                        <td>{{ $member->name }}</td>
                         <td>{{ $member->blood_group }}</td>
                            ...
                            <td>{{ $member->remarks_blood }}</td>
                        <td>
                            @if(Auth::user()->user_role == 1)
                            <form method="post" action="{{ route('others.blood_group_edit') }}">
                                @csrf
